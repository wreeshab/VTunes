    ...
    <div className="h-full flex flex-col">
      <div className="rounded h-2/5 bg-gradient-to-t from-gray-100 to-teal-600 flex flex-col justify-end p-5">
        <div className="flex justify-between items-center pr-10">
          <div>
            <h1 className="text-5xl md:text-8xl font-extrabold mb-2">Playlists</h1>
            <p className="text-lg md:text-xl font-bold text-gray-500">By {user.name}</p>
          </div>
      ...
      <div className="h-3/5 pt-16 w-full flex items-center justify-center">
        <div className="flex flex-col items-center w-11/12 md:w-3/4 overflow-y-scroll gap-3">
